...
onPlayerDowned()
{
	...
	for(;;)
	{
		...
		// Removes custom perk icons.
		self.icon1 Destroy();self.icon1 = undefined;
		self.icon2 Destroy();self.icon2 = undefined;
		self.icon3 Destroy();self.icon3 = undefined;
		self.icon4 Destroy();self.icon4 = undefined;
	}
}
